...
* `!post <сообщение>`, `!почта <сообщение>` - почта. Проигрывает звук, позволяющий привлечь внимание стримера к чату (стоимость: 50 багов, для VIP - 25, для модеров - 25)
...
* `!rip ?` - выводит список счетоводов смерти
...
## Звуковые команды
* `!глаза` (только для стримера)
* `!камень`
* `!непонимаю`
* `!будь` (`!буд`, `!будароф`, `!бударофф`)
* `!эксперименты`